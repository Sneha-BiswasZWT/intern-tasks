        ...
        <>
          {state === "active" ? (
            <div className="tab-single active relative accordian ease-in ">
              <div className="tab-single-inner  bg-secondary text-white  mb-4 pt-4  pb-7">
            ...
            <div>
              <div className="tab-single cursor-pointer mb-4 relative  after:h-full after:absolute after:w-screen after:border-primary after:border-r-0 after:border-5  after:top-0 after:right-full">
